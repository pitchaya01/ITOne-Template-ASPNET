...
namespace Lazarus.Common.EventMessaging
{
    public interface IEventBus
    {
        ...
        void PublishAll(List<IntegrationEvent> @events, IProducer<string, string> p, int? partition = null);
        void PublishAll(List<IntegrationEvent> @events, int? partition = null);
